...
## Output
<img width="847" height="240" alt="Screenshot 2026-08-24 111835" src="https://github.com/user-attachments/assets/14f9c9bf-b181-4b68-b29e-fea58733aae7" />


### Result

Thus, the average number of materials in the system, average number of materials in each conveyor, waiting time of each material in the system, and waiting time of each material in each conveyor were calculated successfully using the given Poisson arrival and exponential service time data.
